...
<body>
    <div class="receipt-container">
        ...
        <div style="display: table; width: 100%; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 2px solid #0052a3;">
            <div style="display: table-cell; width: 30%; vertical-align: top;">
                <div class="company-logo">
                    <!-- Logo placeholder - add your company logo here -->
                    <div style="width: 80px; height: 80px; border: 2px solid #0052a3; display: flex; align-items: center; justify-content: center; font-size: 8pt; color: #0052a3; font-weight: bold;">LOGO</div>
                </div>
            </div>
            <div style="display: table-cell; width: 40%; vertical-align: middle; text-align: center;">
                <div class="credit-note-badge" style="background: #0052a3; color: white; padding: 5px 15px; display: inline-block; font-weight: bold; margin-bottom: 5px;">
                    CREDIT NOTE
                </div>
                <div class="invoice-title" style="font-size: 12pt; font-weight: bold; color: #0052a3;">
