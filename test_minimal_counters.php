...
echo "=== Testing Minimal Counter Set (SaleByTax + SaleByMoneyType) ===\n\n";
...
foreach ($receipts as $receipt) {
    ...
    // A) SaleByTax - NO moneyType dimension
...
usort($fiscalCounters, function ($a, $b) {
    $typeOrder = ['SaleByTax' => 1, 'SaleByMoneyType' => 2];
...
echo "=== Generated Minimal Counter Set ===\n\n";
...
echo "=== Final Payload (Minimal Counter Set) ===\n\n";
...
echo "Expected: 2 (SaleByTax + SaleByMoneyType)\n\n";
