...
// Invoices
#[OA\Post(path: "/invoice/create", summary: "Create invoices", description: "Create invoices with optional ZIMRA fiscalization", tags: ["Invoices"], security: [["AppId" => [], "ApiKey" => []]], requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(required: ["data"], properties: [new OA\Property(property: "data", type: "array", items: new OA\Items(type: "object")), new OA\Property(property: "zimra_fiscalize", type: "boolean", default: false)])), responses: [new OA\Response(response: 201, description: "Success")])]
