...
class DeliveryNoteController extends BaseController
{
    ...
    public function create(Request $request): JsonResponse
    {
        ...
        $response = $this->panierApi->createDeliveryNotes($validated['data']);
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        $data = $validated['data'];
        $response = $this->panierApi->searchDeliveryNotes(
            $data['query'] ?? '*',
            $data['limit'] ?? 10,
            $data['skip'] ?? 0
        );
    ...
    public function download(Request $request): \Symfony\Component\HttpFoundation\StreamedResponse|\Illuminate\Http\JsonResponse
    {
        ...
        $response = $this->panierApi->downloadDeliveryNote($validated['id']);
        return $this->handlePdfDownload($response, "delivery-note-{$validated['id']}.pdf");
    }
    ...
    public function delete(Request $request): JsonResponse
    {
        ...
        $response = $this->panierApi->deleteDeliveryNotes($validated['data']);
        return $this->handleApiResponse($response);
    }
}
